      ...
      <div className="max-w-2xl mx-auto mt-36 px-5">
        <div className="bg-primary text-primary-foreground p-8 rounded-t-xl text-center">
          ...
          <p className="text-lg opacity-90">
            Share your unused items with fellow students who need them
          </p>
        </div>
        ...
        >
          {showSuccess && (
            <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-6 animate-pulse">
              <strong>Success!</strong> Your resource has been posted successfully. It will be
              reviewed and made available to other students soon.
            </div>
          )}
          ...
          <div className="mb-10">
            ...
            <div className="mb-6">
              ...
              <div
                ref={titleErrorRef}
                className="error-message hidden mt-1 text-sm text-destructive"
                id="titleError"
              >
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <label
                  key={option.id}
                  className="condition-option flex items-center p-4 border border-border rounded-lg cursor-pointer hover:bg-secondary transition-colors"
                >
                  <input
                    type="radio"
                    id={option.id}
            ...
            <div
              ref={conditionErrorRef}
              className="error-message hidden mt-2 text-sm text-destructive"
              id="conditionError"
            >
      ...
      {showPreview && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white w-full max-w-lg p-8 rounded-xl shadow-xl relative overflow-y-auto max-h-[90vh]">
            ...
            <p>
              <strong>Title:</strong> {previewData.itemTitle}
            </p>
            <p>
              <strong>Description:</strong> {previewData.description}
            </p>
            <p>
              <strong>Condition:</strong> {previewData.condition}
            </p>
            <p>
              <strong>Location:</strong> {previewData.location}
            </p>
            <p>
              <strong>Available Until:</strong> {previewData.availableUntil || '—'}
            </p>
            <p>
              <strong>Urgent Donation:</strong> {previewData.urgentDonation}
            </p>
            <p>
              <strong>Is Paid:</strong> {previewData.isPaid}
            </p>
            ...
            <p>
              <strong>Contact Methods:</strong> {previewData.contactMethods?.join(', ')}
            </p>
